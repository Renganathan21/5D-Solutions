...
import { Facebook, Twitter, Linkedin, Mail, Phone, MapPin, Clock, Send } from 'lucide-react';
...
export default function Footer({isContact = true} : {isContact: boolean}) {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white">
      {isContact && (<section className="py-24 bg-white dark:bg-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-2xl font-bold text-blue-400">EZIRA</h3>
        ...
        >
          <p className="text-gray-400 text-sm">
            © 2024 EZIRA. All rights reserved.
          </p>
